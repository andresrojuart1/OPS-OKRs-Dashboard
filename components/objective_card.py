    ...
    with st.container():
        ...
        if latest is not None:
            ...
            <div style="display:flex; align-items:center; gap:12px; margin-top:14px; background:rgba(255,255,255,0.03); padding:12px; border-radius:8px; border-left:4px solid {badge_color};">
                <div style="background:{badge_color}1a; color:{badge_color}; padding:4px 10px; border-radius:6px; font-size:15px; font-weight:700; white-space:nowrap;">{_format_badge(val, unit)}</div>
